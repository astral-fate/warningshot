...
\item \textbf{Released, checkable artifacts.} A \texttt{verify.py} recomputes 67
headline numbers from the committed results and prints agreement counts; 92
...
\texttt{Claude\_(language\_model)} &  7{,}852 &  3{,}458 &  0.44 & $91.21\times$ \\
\texttt{OpenAI}                  &  7{,}620 &  2{,}102 &  0.28 & $145.54\times$ \\
...
nonetheless ranges from $3.89\times$ to $145.54\times$ depending on the
...
$92.51\times$ raw and $3.89\times$ to $145.54\times$ normalised --- \textbf{the
...
\texttt{python -m pytest} & 92 tests, no network \\
\texttt{python scripts/verify.py} & 67 headline numbers recomputed from committed results \\
